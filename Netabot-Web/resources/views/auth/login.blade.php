<x-guest-layout>
    ...
    <div class="reveal-1 w-24 h-24 bg-gradient-to-tr from-cyan-500 to-blue-600 rounded-[2rem] shadow-2xl shadow-blue-500/40 flex items-center justify-center border-t border-white/40 animate-float">
